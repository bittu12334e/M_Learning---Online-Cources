...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.FileViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FileViewHolder holder, int position) {
        ...
        /*// Set click listener for editing the file
        holder.btnEditFile.setOnClickListener(view -> {
            Intent editIntent = new Intent(context, EditFileActivity.class);
            editIntent.putExtra("oldFileUrl", fileItem.getFileUrl());
            editIntent.putExtra("fileId", fileItem.getId());
    ...
    static class FileViewHolder extends RecyclerView.ViewHolder {
        ...
        FileViewHolder(View itemView) {
            ...
            //btnEditFile = itemView.findViewById(R.id.btnEditFile);
        }
    }
}
